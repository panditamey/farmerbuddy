...
import com.ameypandit.farmerbuddy.R;
...
//        allow to snap photos
        ...
        myWebView.loadUrl("https://widget.tiledesk.com/v4/assets/twp/index.html?isOpen=true&tiledesk_projectid=6180239335d3380019316c46&tiledesk_fullscreenMode=true&tiledesk_hideHeaderCloseButton=true&tiledesk_isopen=true");
    }
    ...
    public class FileChooserWebChromeClient extends WebChromeClient {
        ...
        public FileChooserWebChromeClient(ChatActivity myActivity) {
